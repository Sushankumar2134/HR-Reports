...
export const DOCUMENTS: IDocument[] = [
  {
    ...
    file_name: 'offer_letter_devin.pdf',
    file_path: 'storage/app/private_documents/offer_letter_devin.pdf',
    file_size: 245000,
    description: 'Initial offer letter',
    uploaded_by: 5,
    created_at: dayjs().subtract(6, 'month').toDate().toISOString(),
    updated_at: dayjs().subtract(6, 'month').toDate().toISOString(),
    status: 'valid',
  },
  {
    id: 2,
    ...
    file_name: 'medical_license_devin.pdf',
    file_path: 'storage/app/private_documents/medical_license_devin.pdf',
    file_size: 156000,
    expiry_date: dayjs().add(3, 'month').toDate().toISOString(),
    description: 'Medical license certificate',
    uploaded_by: 5,
    created_at: dayjs().subtract(8, 'month').toDate().toISOString(),
    updated_at: dayjs().subtract(8, 'month').toDate().toISOString(),
  ...
  },
  {
    ...
    file_name: 'appointment_letter_bella.pdf',
    file_path: 'storage/app/private_documents/appointment_letter_bella.pdf',
    file_size: 189000,
    description: 'Appointment letter for Marketing Director',
    uploaded_by: 5,
    created_at: dayjs().subtract(4, 'month').toDate().toISOString(),
    updated_at: dayjs().subtract(4, 'month').toDate().toISOString(),
    status: 'valid',
  },
  {
    id: 4,
    ...
    file_name: 'certificate_bella.pdf',
    file_path: 'storage/app/private_documents/certificate_bella.pdf',
    file_size: 267000,
    expiry_date: dayjs().subtract(2, 'month').toDate().toISOString(),
    description: 'Professional certification expired',
    uploaded_by: 5,
    created_at: dayjs().subtract(12, 'month').toDate().toISOString(),
    updated_at: dayjs().subtract(12, 'month').toDate().toISOString(),
    status: 'expired',
  },
  {
    id: 5,
    ...
    file_name: 'id_proof_miriam.pdf',
    file_path: 'storage/app/private_documents/id_proof_miriam.pdf',
    file_size: 134000,
    description: 'Government ID proof',
    uploaded_by: 5,
    created_at: dayjs().subtract(10, 'month').toDate().toISOString(),
    updated_at: dayjs().subtract(10, 'month').toDate().toISOString(),
    status: 'valid',
  },
  {
    id: 6,
    ...
    document_type: 'medical_license',
    file_name: 'medical_license_david.pdf',
    file_path: 'storage/app/private_documents/medical_license_david.pdf',
    file_size: 201000,
    expiry_date: dayjs().add(8, 'month').toDate().toISOString(),
    description: 'Current medical license',
    uploaded_by: 5,
    created_at: dayjs().subtract(2, 'month').toDate().toISOString(),
    updated_at: dayjs().subtract(2, 'month').toDate().toISOString(),
    status: 'valid',
  },
  {
    id: 7,
    ...
    document_type: 'certificate',
    file_name: 'certificate_mathew.pdf',
    file_path: 'storage/app/private_documents/certificate_mathew.pdf',
    file_size: 178000,
    expiry_date: dayjs().add(1, 'month').toDate().toISOString(),
    description: 'HR certification expiring soon',
    uploaded_by: 5,
    created_at: dayjs().subtract(11, 'month').toDate().toISOString(),
    updated_at: dayjs().subtract(11, 'month').toDate().toISOString(),
    status: 'expiring_soon',
  },
];
